...
$do = $_GET['do'];
   ...
   if($do == 'add'){
      if(isset($_POST['add'])){
            ...
            $stmt = $con->prepare("INSERT INTO admins ( username , password)
            VALUES(:zusername ,:zpass)");
            $stmt->execute(array(
                'zusername' =>$uname,
                'zpass' => $pass
            ));
            header("Location:admins.php?dmsg=".urlencode("Done Adding Admin"));
            exit();
   ...
   if($do == 'Edit'){
        ...
        $stmt = $con->prepare("UPDATE admins SET username = ? , password = ? WHERE ID = ?");
        $stmt->execute(array($uname,$pass,$IID));

        header("Location:admins.php?dmsg=".urlencode("Done Editing Admin"));
        exit();
   ...
   if($do == 'delete'){
    ...
    if($_GET['id']){
      ...
      header("Location:admins.php?dmsg=".urlencode("Done Deleteing Admin"));
      exit();
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
              ...
              <ul class="breadcrumb">
                ...
                <div class="main-panel">
                    ...
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard - Admins</a></li>
                    ...
                    <div class="col-12 grid-margin">
                        ...
                        <div class="card-body">
                            ...
                            <form class="form-sample" action="adminsop.php?do=add" method="post">
                ...
                <div class="main-panel">
                    ...
                    <div class="col-12 grid-margin">
                        ...
                        <div class="card-body">
                            ...
                            <form class="form-sample" action="adminsop.php?do=Edit" method="post">
                            <p class="card-description">
                            Details
                            </p>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                    <input class="form-control" name="pass" placeholder="" value="<?php echo $director['password'] ?>">
                                    </div>
                                </div>
                                </div>
            ...
            <!-- ============================================================== -->
            <footer class="footer">
                Copyright © 2017 دار التعافي. All rights reserved.
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
