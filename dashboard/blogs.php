      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="page-header">
           ...
           <a href="blogsop.php?do=add"><button  class="col-4 btn btn-outline-success add">Add - BLOGs</button></a>
           <hr>
           <div class="card-columns">
           <?php
             foreach (getReco('blogs') as $ad) {
              ?> 
     
                  
                    <div class="card">
                      <img class="card-img-top" src="images/uploads/blogs/<?php echo $ad['image']?>" alt="Card image cap">
                      <div class="card-body">
                        <h6 class="card-text"><?php echo $ad['day'] . " " . $ad['month'] . " " . $ad['year'] ?></h6>
                        <h4 class="card-title"><?php echo $ad['title']?></h4>
                        <p class="card-textt"><?php echo $ad['text']?></p>
                      </div>
                      <a href="blogsop.php?do=edit&id=<?php echo $ad["ID"] ; ?> "><button class="btn btn-outline-success">Edit</button></a>
                      <a href="blogsop.php?do=delete&id=<?php echo $ad["ID"] ; ?> "><button class="btn btn-outline-success">Delete</button></a>
                    </div>
