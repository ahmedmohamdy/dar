...
<body>
    ...
    <!-- Header navbar end -->
    <div class="coming-soon over-layer-black" id="coming-soon" >
        <div class="inner-bg">
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        ...
                        <div class="content">
                            ...
                            <a href="index.html"><button type="submit" class="btn btn-theme hvr-bounce-to-top" data-text="Send Message"><span>Back To Home Page</span></button></a>
                        </div>
                    </div>
                </div>
            </div>
